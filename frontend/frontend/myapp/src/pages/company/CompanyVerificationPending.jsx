      ...
      <style>{`
        ...
        * {
        ...
        @media (max-width: 360px) {
          .pending-wrapper { padding: 1.8rem 1.4rem; }
      ...
      <div className="page">
        ...
        <div className="pending-wrapper">
          <div className="logo-section">
            ...
            <h2 className="title">Verification Pending</h2>
          </div>

          <p className="subtitle">
            Your company <strong>{email}</strong> has been successfully registered.
          </p>

          <p className="info-text">
            It is currently <strong>awaiting admin approval</strong>.
          </p>

          <p className="info-text">
            You will receive access once verification is complete.
          </p>
